...
`764813b086334b5732cc3a037c9766a4a09a9978` / tree
`710aa6c07f15cd50a0820620b309bdf1a509dea1`. The packet verification script
...
| Fresh owner apply | public base `190ea95eda41fbf5d1521d433b3365d87b9cfe57`; candidate `764813b086334b5732cc3a037c9766a4a09a9978` / tree `710aa6c07f15cd50a0820620b309bdf1a509dea1`; exact patch and before/after hashes in `coworld-adapter/testing/owner-upgrade/SHA256SUMS`                               | Exact ledger cardinality, candidate commit/tree/blobs, `git apply --check`, complete-file hashes, install, Node tests, syntax, and check-only doctor from a fresh exact-base checkout | **LOCAL PASS:** verifier returned `PASS` for all 13 required files; patch SHA-256 `ec72838ff998af61bcd2cfef955b8d017969a7d71a02d7efb73ff2592490f127`; ledger SHA-256 `6f7f4d72bc1bc76806ef223f8fb2e07904d799ff81a367e5803bbfe66d3ea3b0`; doctor returned ready. Upload and owner XP remain separate owner/operator actions and are not claimed.                                      |
