...
patch byte, or after-apply file byte.
...
| Fresh owner apply | public base `190ea95eda41fbf5d1521d433b3365d87b9cfe57`; exact patch and before/after hashes in `coworld-adapter/testing/owner-upgrade/SHA256SUMS`                                                                                | `git apply --check`, complete-file hashes, Node tests, syntax checks, and doctor from a fresh exact-base checkout                                                                | **LOCAL PASS** when the checked-in verifier exits zero. Upload and owner XP remain operator/owner actions and are not claimed by this packet.                                                                                                                                                                                                                 |
