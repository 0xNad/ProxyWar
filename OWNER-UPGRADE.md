...
| Spatial/minimap   | bounded v1 source candidate only; no Coworld/policy/request identity yet                                                                                                                                                         | Sealed Coworld image inspection receipt; bounded wire/prompt/memory; exact offered gameplay ID; matched off/on episodes with identical non-spatial config                                                      | **BLOCKED / no gameplay claim:** local v1 implementation gates pass, but no sealed Coworld image receipt or XP request exists. Rich v2 remains unimplemented: no coordinate frame, elevation, positioned structures/units/warships, weighted land/naval exposure, or terrain minimap.                                                                         |
