...
// Ported from today's upstream OpenFront stats-column registry
// (src/client/hud/layers/lib/StatsColumns.ts); icons resolved directly here
// because our fork has no HotbarIcons module.
const allianceIcon = assetUrl("images/AllianceIcon.svg");
const cityIcon = assetUrl("images/CityIconWhite.svg");
const claimIcon = assetUrl("images/ClaimIcon.svg");
const factoryIcon = assetUrl("images/FactoryIconWhite.svg");
const goldCoinIcon = assetUrl("images/GoldCoinIcon.svg");
const guildIcon = assetUrl("images/GuildIconWhite.svg");
const missileSiloIcon = assetUrl("images/MissileSiloIconWhite.svg");
const portIcon = assetUrl("images/PortIcon.svg");
const profileIcon = assetUrl("images/ProfileIcon.svg");
const samLauncherIcon = assetUrl("images/SamLauncherIconWhite.svg");
const soldierIcon = assetUrl("images/SoldierIcon.svg");
const teamIcon = assetUrl("images/TeamIconSolidWhite.svg");
const traitorIcon = assetUrl("images/TraitorIcon.svg");
const upperLimitIcon = assetUrl("images/UpperLimitIcon.svg");
...
export const COLUMN_DEFS: readonly ColumnDef[] = [
  ...
  defineColumn({
    ...
    align: "center",
    // Our PlayerView carries betrayals as update data, not a method.
    value: (player) => Number(player.data.betrayals ?? 0),
    cell: (row) => renderNumber(row.value),
  }),
];
