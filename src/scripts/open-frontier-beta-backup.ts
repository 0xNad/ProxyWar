...
const nationsDir =
  ...
  path.join(cwd, "artifacts", "open-frontier", "nations");

const runtimeSources = [
  ["jobs", path.join(cwd, "artifacts", "ai-league-demo-jobs")],
  ["saved-nations", nationsDir],
  ["active-roster", path.join(cwd, "artifacts", "open-frontier", "active-roster")],
  ["feedback", path.join(cwd, "artifacts", "open-frontier", "beta-feedback")],
  ["external-agent-secrets", path.join(cwd, "artifacts", "open-frontier", "secrets")],
  ["rate-limits", path.join(cwd, "artifacts", "open-frontier", "rate-limits.json")],
] as const;
...
console.log("Open Frontier beta backup created", {
  backupID,
  destinationRoot,
