...
import {
  OpenFrontierMatchPackageSummary,
  writeOpenFrontierMatchPackageArtifacts,
} from "../server/agents/OpenFrontierMatchPackage";
import {
  AgentBrainType,
...
await writeOpenFrontierMatchPackageArtifacts({
  directory,
  summary: nextSummary as OpenFrontierMatchPackageSummary,
});
...
interface ExistingMatchSummary extends OpenFrontierMatchPackageSummary {
  brainMode?: string;
  scenario?: string;
}
