          ...
          <td class="links">
            ...
            ${
              run.hasOpenFrontReplay
                ? `<a href="/ai-league-replay/${encodeURIComponent(run.runID)}">Open Frontier render</a>`
                : ""
            }
...
<head>
  ...
  <title>Open Frontier Runs</title>
  <style>
...
<body>
  ...
  <main>
    ...
    ${
      runs.length === 0
        ? '<div class="empty">No Open Frontier runs have been written yet.</div>'
        : `<table>
            <thead>
              <tr>
