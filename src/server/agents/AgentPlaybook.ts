...
export const openFrontAgentPlaybook = [
  "Open Frontier priorities: expand territory, preserve enough troops to defend, build economy, then attack only when the target is weak or strategically exposed.",
