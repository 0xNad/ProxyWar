...
export const openFrontAgentPlaybook = [
  ...
  "Diplomacy: alliances secure flanks; choose only exact offered donation actions when supporting a strategically useful recipient. Structured support_request deals remain friendly-only. Use embargo to choke a rival's gold, target_player to mark a focus rival, and break_alliance to betray an ally when betrayal clearly converts to a winning position (ally early, betray late and decisively).",
