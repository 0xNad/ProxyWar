...
describe("AgentDecisionLogWriter", () => {
  it("writes JSONL decisions, match summary, Markdown report, and visual report", async () => {
    ...
    const record: AgentDecisionRecord = {
      ...
      legalActionIDs: [
        "alliance:request:RIVAL",
        "build:Defense Post:10",
        "hold",
      ],
      legalActionIDsByKind: {
        alliance_request: ["alliance:request:RIVAL"],
        build: ["build:Defense Post:10"],
        hold: ["hold"],
      },
      submissionLegalActionIDs: ["build:Defense Post:10", "hold"],
      submissionLegalActionIDsByKind: {
        build: ["build:Defense Post:10"],
        hold: ["hold"],
      },
      originalRequestedActionIDs: ["alliance:request:RIVAL"],
      originalRequestedActionIDCount: 1,
      withdrawnRequestedActionIDs: ["alliance:request:RIVAL"],
      withdrawnRequestedActionIDCount: 1,
      offerRetryCount: 1,
      offerRetryLatencyMs: 17,
      attackActionIDs: [],
      ...
      decisionMetadata: {
        ...
        llmPlannerDegradedAttemptCount: 0,
        timedOutAttemptCount: 0,
        offerRetryMode: "brain-retry",
        firstAttemptFallbackUsed: false,
        firstAttemptPlannerFallbackUsed: false,
        firstAttemptExternalActionCallCount: 1,
        firstAttemptSelectedActionID: "alliance:request:RIVAL",
        firstAttemptExternalFailureReason: "transient provider failure",
        retryAttemptFallbackUsed: false,
        retryAttemptPlannerFallbackUsed: false,
        retryAttemptExternalActionCallCount: 1,
        retryAttemptSelectedActionID: "build:Defense Post:10",
        fallbackUsed: false,
