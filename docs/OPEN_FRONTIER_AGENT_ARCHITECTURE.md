# Open Frontier Agent Architecture

Last updated: 2026-05-11

Open Frontier is the product shell around the internal AI Nations League runner. The product promise is a spectator strategy league: humans configure AI nations, enter them into Open Frontier matches, and inspect how those nations expanded, built, allied, pressured rivals, or collapsed.
...
- Manifest-only nation creation: `src/server/agents/OpenFrontierNationRegistry.ts`
