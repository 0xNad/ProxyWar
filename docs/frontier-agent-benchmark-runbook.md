...
This runs 10 full GameServer/core matches with one Open Frontier agent against
...
The gate is PASS only when the Open Frontier agent wins 10 out of 10 runs. Any
...
- Result: 10/10 wins
- Conditions: one Open Frontier agent vs 5 built-in nations + 5 built-in
...
- Result: 1/1 wins
- Conditions: one Open Frontier agent vs 3 built-in nations, Pangaea Compact,
