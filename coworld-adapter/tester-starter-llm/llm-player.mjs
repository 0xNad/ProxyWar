...
function buildState(obs, actions) {
  ...
  // the shape above. NOTE: tests/coworld/StarterEconomyState.test.ts evals
  // clean() and buildState() extracted from this file's source text — keep
  // both functions self-contained.
  let econ;
  if (obs.economy) {
