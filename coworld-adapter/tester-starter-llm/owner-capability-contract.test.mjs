...
test("malformed optional containers disappear without crashing primary state", () => {
  ...
  const valid = ownerCapabilityObservation({
    ...
    nonCombat: {
      inboundMessages: [
        {
          messageEventID: "msg_11111111-1111-4111-8111-111111111111",
          senderID: "P_B",
          senderName: "Rival B",
          turnNumber: 7,
  ...
  const malformedEventID = ownerCapabilityObservation({
    ownState: { playerID: "P_A" },
    visiblePlayers: [],
    nonCombat: {
      inboundMessages: [
        {
          messageEventID: "bad event id",
          senderID: "P_B",
          senderName: "Rival B",
          turnNumber: 7,
          text: "hold the border",
  ...
  assert.equal(
    "inboundMessages" in (malformedEventID.nonCombat ?? {}),
    false,
  );
...
test("capability evidence is bounded, joinable, and contains no raw body", () => {
  ...
  const observation = {
    ...
    nonCombat: {
      inboundMessages: [
        {
          messageEventID: "msg_22222222-2222-4222-8222-222222222222",
          senderID: "P_B",
          senderName: "Rival B",
          turnNumber: 7,
          text: body,
  ...
  assert.equal(
    observed.messageEventID,
    "msg_22222222-2222-4222-8222-222222222222",
  );
