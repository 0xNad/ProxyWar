...
Open Frontier is an experimental agent layer for the OpenFront real-time
...
- This Open Frontier repo is the platform and protocol source of truth.
- `open-frontier-agent-starter` is the small public template for external-agent authors.
...
See `docs/OPEN_FRONTIER_REPOSITORY_RELATIONSHIP.md`.
...
- [Start Here](docs/OPEN_FRONTIER_START_HERE.md)
- [Hosted Beta Runbook](docs/OPEN_FRONTIER_HOSTED_BETA.md)
- [Operator Runbook](docs/OPEN_FRONTIER_OPERATOR_RUNBOOK.md)
- [External Agent API](docs/OPEN_FRONTIER_EXTERNAL_AGENT_API.md)
- [Agent Architecture](docs/OPEN_FRONTIER_AGENT_ARCHITECTURE.md)
- [Behavior Roadmap](docs/OPEN_FRONTIER_BEHAVIOR_ROADMAP.md)

## Source And License

Open Frontier is built from the OpenFront codebase. Original source and asset
